(** Market data websockets api for the Gemini trading exchange. This broadcasts
    only public events and require no authentication. *)
open! Common
...
module Event_type : sig
  (** Market data event types. One of [`Trade], [`Change], [`Auction], or
      [`Block_trade]. *)
  type t =
    [ `Trade
    | `Change
...
(** An change event to an order. The [reaosn] field indicates the type of
    change. *)
